...
let CheckoutComponent = class CheckoutComponent {
    ...
    ngOnInit() {
        ...
        this.dogService.getPet(this.dogId).subscribe(data => {
            this.dog = data;
        }, error => {
            console.log(error);
        });
...
let CreateProductComponent = class CreateProductComponent {
    constructor(dogService, router, userService) {
        this.dogService = dogService;
        this.router = router;
        this.userService = userService;
    ...
    onFileSelected(event) {
        ...
        if (file != null) {
            ...
            this.dogService.uploadImage(file).subscribe(res => {
                console.log(res);
    ...
    submit() {
        ...
        this.dogService.registerPet(this.dogModel).subscribe(data => {
...
let ProductDetailComponent = class ProductDetailComponent {
    constructor(route, router, petsService, userService) {
        this.route = route;
        this.router = router;
    ...
    ngOnInit() {
        this.dogId = this.route.snapshot.paramMap.get('id');
        this.petsService.getPet(this.dogId).subscribe(data => {
            this.dog = data;
            this.userService.getUserById(data.user).subscribe(user => {
                this.user = user;
                console.log(user);
            }, err => {
                console.log(err);
...
let UserService = class UserService {
    ...
    getUser() {
        this.http.get(this.serverUrl + '/user').subscribe(data => {
            this.user = data;
        }, error => {
...
let ShowPetsComponent = class ShowPetsComponent {
    constructor(petsService, router, userService) {
        this.petsService = petsService;
        this.router = router;
        this.userService = userService;
        this.pets = [];
    ...
    ngOnInit() {
        this.petsService.getPets().subscribe(data => (this.pets = data), error => {
            console.log(error);
        });
        this.userService.getUser();
    }
...
ShowPetsComponent.ctorParameters = () => [
